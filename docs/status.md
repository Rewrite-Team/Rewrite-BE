...
| REQ-003 | 자기소개서 기본 CRUD | Planned | High | API-007, API-008, API-012, API-013 | [#5](https://github.com/Rewrite-Team/Rewrite-BE/issues/5), [PR #15](https://github.com/Rewrite-Team/Rewrite-BE/pull/15) | - | 다음 slice 후보 기준으로 분리 진행 |
...
| 자기소개서 초안 생성 | REQ-003 | API-008 | current user 기반 draft 생성, response DTO, validation 없는 생성 흐름, service/web test |
