...
| API 추가, 삭제, path/request/response/error/validation/상태/구현 여부 변경 | `api/README.md`, 관련 `api/*.md`, Notion `Rewrite API (자동 동기화)`, 필요 시 `requirements.md`, `decisions/`, `status.md` | Markdown·코드·Notion의 API ID, 상세 명세와 상태가 모두 일치하는가 |
