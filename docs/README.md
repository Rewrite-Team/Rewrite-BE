...
| `decisions/README.md` | API 설계 결정 인덱스와 도메인별 결정 문서 라우팅 | 설계 이유 확인, 결정 변경 검토 |
| `decisions/*.md` | 도메인별 API 설계 결정과 트레이드오프 | 특정 도메인 설계 결정 확인 |
...
- 설계 결정의 배경이 필요할 때만 `decisions/README.md`와 관련 `decisions/` 도메인 문서를 읽는다.
